    ...
    internal partial class ActorEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "ApiPeliculasEFCore.Entidades.Actor",
                typeof(Actor),
                baseEntityType);
            ...
            var apellido = runtimeEntityType.AddProperty(
                "Apellido",
                typeof(string),
                propertyInfo: typeof(Actor).GetProperty("Apellido", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Actor).GetField("<Apellido>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            apellido.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
            ...
            var nombre = runtimeEntityType.AddProperty(
                ...
                fieldInfo: typeof(Actor).GetField("_nombre", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                maxLength: 150);
