    ...
    public partial class DatosDePrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 10, 22, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 10, 15, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 10, 20, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 10, 15, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "PeliculasId", "SalaDeCineId" },
                values: new object[,]
                {
                    { 5, 1 },
                    { 5, 2 },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "GeneroPelicula",
                keyColumns: new[] { "GeneroId", "PeliculasId" },
            ...
            migrationBuilder.DeleteData(
                table: "PeliculaSalaDeCine",
                keyColumns: new[] { "PeliculasId", "SalaDeCineId" },
